...
<div class="clearfix comment-box<?php echo $commentBoxIndentStyle; ?>">
...
<div class="<?php if ($this->getVar('comments-panel-visible', 0) == 1){ echo 'adminenable'; }; ?> comment-body" id="comment-body-<?php echo $comment->id; ?>">
<?php			// Begin Title 
